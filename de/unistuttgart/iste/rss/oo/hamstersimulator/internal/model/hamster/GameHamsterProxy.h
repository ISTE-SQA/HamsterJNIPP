#ifndef __de_unistuttgart_iste_rss_oo_hamstersimulator_internal_model_hamster_GameHamsterProxy_H
#define __de_unistuttgart_iste_rss_oo_hamstersimulator_internal_model_hamster_GameHamsterProxy_H
							...
							namespace model
							{
								namespace hamster
								{
									...
									public:
										...
										operator jobject();
										// constructors
										GameHamsterProxy(jobject obj);
										GameHamsterProxy();

										virtual ~GameHamsterProxy();
										GameHamsterProxy& operator=(const GameHamsterProxy& rhs);
