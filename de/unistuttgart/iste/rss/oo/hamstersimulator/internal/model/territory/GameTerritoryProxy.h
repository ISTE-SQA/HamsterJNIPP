#ifndef __de_unistuttgart_iste_rss_oo_hamstersimulator_internal_model_territory_GameTerritoryProxy_H
#define __de_unistuttgart_iste_rss_oo_hamstersimulator_internal_model_territory_GameTerritoryProxy_H
						...
						namespace internal
						{
							namespace model
							{
								namespace territory
								{
									...
									protected:
										GameTerritoryProxy(void* unused);
									...
									public:
										...
										operator jobject();
										// constructors
										GameTerritoryProxy(jobject obj);
										GameTerritoryProxy();

										virtual ~GameTerritoryProxy();
										GameTerritoryProxy& operator=(const GameTerritoryProxy& rhs);

										// methods
										/*
										 * GameHamster getDefaultHamster();
										 */
										::de::unistuttgart::iste::rss::oo::hamstersimulator::internal::model::hamster::GameHamsterProxy getDefaultHamster();
										/*
